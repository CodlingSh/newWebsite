...
const projectOnClick = async (e) => {
    ...
    dynamicStyle.innerHTML = ".tempStyle {position: fixed; margin: 0; top: " + top + "px; left: " + left + "px; width: " + width + "px; height: " + height + "px;} .activeStyle {position: fixed; left: 25vw; top: 10vh; height: 80vh; width: 50vw; z-index: 9001;}"

...
function throttle(func, limit) {
  ...
  const scrollFunction = () => {
    console.log(window.scrollY + viewportHeight);
   
    // Check which section we are scrolled to
    if (window.scrollY + viewportHeight < 1000) {
      ...
      console.log("home")
    } if (window.scrollY + viewportHeight > aboutRect && window.scrollY + viewportHeight < skillsRect) {
        ...
        console.log("about")
    } if (window.scrollY + viewportHeight > skillsRect && window.scrollY + viewportHeight < projectsRect) {
        homeLink.classList.remove("active");
        aboutLink.classList.remove("active");
        ...
        console.log("skills")
    } if (window.scrollY + viewportHeight > projectsRect && window.scrollY + viewportHeight < contactRect) {
        homeLink.classList.remove("active");
        aboutLink.classList.remove("active");
        skillsLink.classList.remove("active");
    ...
    } if (window.scrollY + viewportHeight > contactRect) {
        homeLink.classList.remove("active");
        aboutLink.classList.remove("active");
        skillsLink.classList.remove("active");
        projectLink.classList.remove("active");
